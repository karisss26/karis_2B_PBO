...
<head>
    <title></title>
    <style type="text/css">
        /* --- KESALAHAN SYNTAX CSS DI SINI --- */
        .background_border { /* Diperbaiki: Menggunakan class selector */
            margin: 0px 230px;
            color: white;
        }
    </style>
...
<body>
    ...
    <form class="background_border" method="get"> <input type="text" name="cari" placeholder="Cari Nama Barang">
