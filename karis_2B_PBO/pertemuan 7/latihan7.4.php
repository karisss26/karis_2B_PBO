...
class komputer {
    ...
    // property diubah ke protected supaya bisa diakses oleh subclass
    ...
    // diubah ke protected supaya subclass bisa memanggilnya
...
class laptop extends komputer{
    ...
    public function display_processor() {
        // sekarang bisa akses karena $jenis_processor protected
        return $this->jenis_processor;
    }
    ...
    public function display_ram2() {
        // tampilkan_ram sekarang protected, jadi bisa dipanggil
    ...
    public function display_processorkomputer() {
        // lebih aman panggil method parent yg public
        return $this->tampilkan_processor();
    }
}
